# -*- coding: utf-8 -*-
{
    ...
    'data': [
        ...
        'views/res_partner_exo_views.xml',
        'report/report_invoice.xml',
        'report/invoices_summary_report.xml',
        'report/report_incoming_doc_summary.xml',
        'wizards/fae_read_local_doc_wizard.xml',
        'wizards/fae_invoices_summary_report_wizard.xml',
        'wizards/fae_incoming_doc_summary_report_wizard.xml',
        ...
        # 'cron_task/cron_fae_incoming_doc_reload.xml',
    ],
