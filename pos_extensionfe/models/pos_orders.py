...
class PosOrderInherit(models.Model):
    ...
    def action_recrea_documento(self):
        ...
        if self.x_move_type == 'invoice':
            # es un Cargo (Factura, Tiqute o ND), entonces crea un reembolso y nuevamente el cargo
    ...
    # TEmporalmente re-implementado en waterpump por un error, luego se quita
    def action_pos_order_paid(self):
        ...
        _logger.warning('>> total %s   amount paid: %s  currency_id: %s  rounding: %s',
                        total, self.amount_paid, self.currency_id.id, self.currency_id.rounding)
