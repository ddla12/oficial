...
class FaeAccountInvoice(models.Model):
    ...
    #     self._compute_x_overdue_bill_count_message
        ...
        #
        #     if amount_residual_by_currency:
        #         self.x_overdue_bill_count_message = self._get_overdue_bill_count_message(amount_residual_by_currency)
        #     else:
        #         self.x_overdue_bill_count_message = None

    def _get_overdue_bill_count_message(self, amount_residual_by_currency):
        overdue_bill_count_message = 'Este cliente tiene facturas vencidas con pagos pendientes.( \n'
        cant = 0
        for amount in amount_residual_by_currency:
            cant += 1
            ...
            overdue_bill_count_message += str(amount.get('currency')) + ': ' + str(amount.get('amount_residual')) + '\n'
        overdue_bill_count_message += ')'
        return overdue_bill_count_message